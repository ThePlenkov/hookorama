...
| `PROJECT_STATE.md`                           | `.agents/rules/project-state.md.rule`                | Groundhog-day anchor for Mayor and any agent after a context reset; updated by PRs that change topology or close an open question.             |
